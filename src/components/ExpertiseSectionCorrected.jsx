...
const ExpertiseSectionCorrected = () => {
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {advantages.map((advantage, index) => (
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-semibold text-aa-navy">{advantage.title}</h3>
              </div>
        ...
        >
          ...
          <motion.div variants={itemVariants} className="space-y-8">
            <div>
              <h3 className="text-xl font-bold text-aa-navy mb-6">Geographic Expertise</h3>
              ...
              {regions.map((region, index) => (
                ...
                >
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className={`text-lg font-semibold text-${region.color} mb-2`}>
                        {region.title}
                      </h4>
          ...
          >
            <div className="relative">
              ...
              {/* Text box positioned at top-right */}
              ...
              {/* Corrected Location dots - shifted left and down to be on landmasses */}
              {/* Singapore - Red dot */}
              <motion.div
                className="absolute bottom-[25%] left-[55%] w-4 h-4 bg-aa-red rounded-full shadow-lg"
                animate={{ scale: [1, 1.3, 1] }}
                transition={{ duration: 2, repeat: Infinity, delay: 0 }}
              />
              
              {/* Malaysia Penang - Beige dot */}
              <motion.div
                className="absolute bottom-[35%] left-[50%] w-3 h-3 bg-aa-gold rounded-full shadow-lg"
              ...
              {/* Vietnam - Beige dot */}
              <motion.div
                className="absolute bottom-[45%] left-[52%] w-3 h-3 bg-aa-gold rounded-full shadow-lg"
                animate={{ scale: [1, 1.2, 1] }}
              ...
              {/* Hong Kong - Beige dot */}
              <motion.div
                className="absolute top-[50%] left-[58%] w-3 h-3 bg-aa-gold rounded-full shadow-lg"
                animate={{ scale: [1, 1.2, 1] }}
                transition={{ duration: 2, repeat: Infinity, delay: 0.6 }}
              />
              
              {/* China Shanghai - Beige dot */}
              <motion.div
                className="absolute top-[45%] left-[60%] w-3 h-3 bg-aa-gold rounded-full shadow-lg"
                animate={{ scale: [1, 1.2, 1] }}
                transition={{ duration: 2, repeat: Infinity, delay: 0.8 }}
              />
              
              {/* China Dalian - Beige dot */}
              <motion.div
                className="absolute top-[35%] left-[58%] w-3 h-3 bg-aa-gold rounded-full shadow-lg"
                animate={{ scale: [1, 1.2, 1] }}
                transition={{ duration: 2, repeat: Infinity, delay: 1.0 }}
              />
              
              {/* China Sichuan - Beige dot */}
              <motion.div
                className="absolute top-[55%] left-[45%] w-3 h-3 bg-aa-gold rounded-full shadow-lg"
                animate={{ scale: [1, 1.2, 1] }}
                transition={{ duration: 2, repeat: Infinity, delay: 1.2 }}
              />
              
              {/* Japan Tokyo - Beige dot */}
              <motion.div
                className="absolute top-[30%] left-[70%] w-3 h-3 bg-aa-gold rounded-full shadow-lg"
                animate={{ scale: [1, 1.2, 1] }}
                transition={{ duration: 2, repeat: Infinity, delay: 1.4 }}
              />
              
              {/* Korea Busan - Beige dot */}
              <motion.div
                className="absolute top-[35%] left-[65%] w-3 h-3 bg-aa-gold rounded-full shadow-lg"
                animate={{ scale: [1, 1.2, 1] }}
        ...
        >
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <motion.div variants={itemVariants} className="text-center">
              ...
              <h4 className="text-lg font-semibold mb-3">Trusted by Leading Hotel Groups</h4>
            ...
            <motion.div variants={itemVariants} className="text-center">
              ...
              <h4 className="text-lg font-semibold mb-3">Curated & Sourced on Demand</h4>
              <p className="text-sm text-gray-300">
            ...
            <motion.div variants={itemVariants} className="text-center">
              ...
              <h4 className="text-lg font-semibold mb-3">Full-Service Logistics Solution</h4>
              <p className="text-sm text-gray-300">
...
export default ExpertiseSectionCorrected;
