        ...
        >
          ...
          >
            <div className="relative">
              ...
              {/* Location dots */}
              {/* Singapore - Red dot at bottom */}
              <motion.div
                className="absolute bottom-[15%] right-[45%] w-4 h-4 bg-aa-red rounded-full shadow-lg"
              ...
              <motion.div
                className="absolute bottom-[25%] right-[50%] w-3 h-3 bg-aa-gold rounded-full shadow-lg"
              ...
              {/* Vietnam - Beige dot */}
              <motion.div
                className="absolute bottom-[35%] right-[42%] w-3 h-3 bg-aa-gold rounded-full shadow-lg"
                animate={{ scale: [1, 1.2, 1] }}
              ...
              {/* Hong Kong - Beige dot */}
              <motion.div
                className="absolute bottom-[40%] right-[35%] w-3 h-3 bg-aa-gold rounded-full shadow-lg"
                animate={{ scale: [1, 1.2, 1] }}
              ...
              <motion.div
                className="absolute top-[45%] right-[32%] w-3 h-3 bg-aa-gold rounded-full shadow-lg"
                animate={{ scale: [1, 1.2, 1] }}
              ...
              <motion.div
                className="absolute top-[35%] right-[28%] w-3 h-3 bg-aa-gold rounded-full shadow-lg"
                animate={{ scale: [1, 1.2, 1] }}
              ...
              <motion.div
                className="absolute top-[50%] left-[35%] w-3 h-3 bg-aa-gold rounded-full shadow-lg"
                animate={{ scale: [1, 1.2, 1] }}
              ...
              <motion.div
                className="absolute top-[30%] right-[15%] w-3 h-3 bg-aa-gold rounded-full shadow-lg"
                animate={{ scale: [1, 1.2, 1] }}
              ...
              <motion.div
                className="absolute top-[35%] right-[20%] w-3 h-3 bg-aa-gold rounded-full shadow-lg"
                animate={{ scale: [1, 1.2, 1] }}
...
export default ExpertiseSectionUpdated;
